...
if not development_mode:
    ...
    from api.endpoints import marketplace, futures_bot, user_principals, paypal_payments, prompts, bot_prompts
else:
    from api.endpoints import auth, bots, admin, exchange_credentials, credentials, futures_bot, user_principals, prompts, bot_prompts
